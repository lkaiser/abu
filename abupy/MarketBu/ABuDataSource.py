...
from ..MarketBu.ABuDataFeed import BDApi,TSApi, TXApi, NTApi, HBApi, SNUSApi, SNFuturesApi, SNFuturesGBApi
...
source_dict = {EMarketSourceType.E_MARKET_SOURCE_bd.value: BDApi,
               ...
               EMarketSourceType.E_MARKET_SOURCE_ts.value:TSApi}
